...
public abstract class UsefulTestCase extends TestCase {
  ...
  static void doCheckForSettingsDamage( CodeStyleSettings oldCodeStyleSettings,  CodeStyleSettings currentCodeStyleSettings) {
...
//    }
   ...
   */
  protected final void edt( ThrowableRunnable<Throwable> runnable) {
  ...
  @SafeVarargs
  public static <T> void assertOrderedEquals( Iterable<? extends T> actual, T  ... expected) {
    assertOrderedEquals("", actual, expected);
  }

  public static void assertOrderedEquals(byte  [] actual, byte  [] expected) {
  ...
  public static void assertOrderedEquals(int  [] actual, int  [] expected) {
  ...
  @SafeVarargs
  public static <T> void assertOrderedEquals( String errorMsg,  Iterable<? extends T> actual, T  ... expected) {
    assertOrderedEquals(errorMsg, actual, Arrays.asList(expected));
  }

  public static <T> void assertOrderedEquals( Iterable<? extends T> actual,  Iterable<? extends T> expected) {
    assertOrderedEquals("", actual, expected);
  }
  ...
  private static <T> boolean equals( Iterable<? extends T> a1,
                                     Iterable<? extends T> a2,
                                     BiPredicate<? super T, ? super T> predicate) {
   ...
   */
  @SafeVarargs
  public static <T> void assertSameElements(T  [] actual, T  ... expected) {
   ...
   */
  @SafeVarargs
  public static <T> void assertSameElements( Collection<? extends T> actual, T  ... expected) {
   ...
   * Checks {@code actual} contains same elements (in {@link #equals(Object)} meaning) as {@code expected} irrespective of their order
   */
  public static <T> void assertSameElements( Collection<? extends T> actual,  Collection<? extends T> expected) {
   ...
   * Checks {@code actual} contains same elements (in {@link #equals(Object)} meaning) as {@code expected} irrespective of their order
   */
  public static <T> void assertSameElements( String message,  Collection<? extends T> actual,  Collection<? extends T> expected) {
  ...
  public static <T> void assertContainsOrdered( Collection<? extends T> collection,  Collection<? extends T> expected) {
  ...
  public static <T> void assertContainsElements( Collection<? extends T> collection,  Collection<? extends T> expected) {
  ...
  public static <T> void assertDoesntContain( Collection<? extends T> collection,  Collection<? extends T> notExpected) {
  ...
  private static <T> Throwable accepts( Consumer<? super T> condition, final T actual) {
    try {
  ...
  public static <T> T assertOneElement( Collection<? extends T> collection) {
  ...
  public static <T> void assertEmpty( String errorMsg,  Collection<? extends T> collection) {
  ...
  public static void assertSameLines(@Nullable String message,  String expected,  String actual) {
  ...
  public static void assertSameLinesWithFile( String filePath,
                                              String actualText,
                                              Supplier<String> messageProducer) {
  ...
  protected static void clearFields( Object test) throws IllegalAccessException {
  ...
  private static void checkCodeStyleSettingsEqual( CodeStyleSettings expected,  CodeStyleSettings settings) {
  ...
  private static void checkCodeInsightSettingsEqual( CodeInsightSettings oldSettings,  CodeInsightSettings settings) {
  ...
  public static void doPostponedFormatting( Project project) {
   ...
   */
  protected void assertException( AbstractExceptionCase<?> exceptionCase) {
   ...
   */
  public static <T extends Throwable> void assertThrows( Class<? extends Throwable> exceptionClass,
...
//      }
  ...
  protected boolean annotatedWith( Class<? extends Annotation> annotationClass) {
  ...
  public static void refreshRecursively( VirtualFile file) {
  ...
  public static VirtualFile refreshAndFindFile( final File file) {
    return UIUtil.invokeAndWaitIfNeeded(() -> LocalFileSystem.getInstance().refreshAndFindFileByIoFile(file));
  }

  public static void waitForAppLeakingThreads(long timeout,  TimeUnit timeUnit) {
