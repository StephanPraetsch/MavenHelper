...
public abstract class BaseAction extends DumbAwareAction {
    ...
    public BaseAction(Project myProject, MavenProject myMavenProject, MavenArtifactNode myTreeNode, final String text,
                      DomManagerSupplier domManagerSupplier) {
		super(text);
		this.myProject = myProject;
		this.myMavenProject = myMavenProject;
		this.myArtifact = myTreeNode;
		this.domManagerSupplier = domManagerSupplier;
	}
...
//			showError(mavenArtifactNode);
		...
		DomFileElement<MavenDomProjectModel> fileElement = domManagerSupplier.get(myProject).getFileElement(xmlFile, MavenDomProjectModel.class);
